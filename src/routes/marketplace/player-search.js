...
router.post(
    ...
    [
        ...
        body("lastModifiedDateFrom").optional().isISO8601(),
        body("lastModifiedDateTo").optional().isISO8601(),
        body("startDateFrom").optional().isISO8601(),
        body("startDateTo").optional().isISO8601(),
