...
async function pageWatchers(baseCfg) {
    ...
    const qWatchers = await prompts([{
        ...
        type: "toggle",
        name: "ENABLE_CREATOR_PARTNER_WATCHER",
        message: BRAND_TEXT("Enable Creator Partner Watcher (track added and removed partners)"),
        initial: (baseCfg.ENABLE_CREATOR_PARTNER_WATCHER || "true") === "true",
        active: "yes",
        inactive: "no"
    }, {
        type: "toggle",
...
function askConfig(baseCfg) {
    return (async () => {
        ...
        const out = {
            ...
            OS: baseCfg.OS || "iOS",
            PLAYFAB_DEVICE_ID: baseCfg.PLAYFAB_DEVICE_ID || `vmc-${genSecret(16)}`,
            EXPOSE_SENSITIVE_CATALOG_FIELDS: baseCfg.EXPOSE_SENSITIVE_CATALOG_FIELDS || "false",
            EXPOSE_SENSITIVE_EVENT_FIELDS: baseCfg.EXPOSE_SENSITIVE_EVENT_FIELDS || "false",
            ...
            ENABLE_CONTENT_UPDATE_WATCHER: baseCfg.ENABLE_CONTENT_UPDATE_WATCHER ?? (qWatchers.ENABLE_ITEM_WATCHER ? 'true' : 'false'),
            ENABLE_SUBSCRIPTION_WATCHER: baseCfg.ENABLE_SUBSCRIPTION_WATCHER ?? 'true',
            ITEM_WATCH_INTERVAL_MS: baseCfg.ITEM_WATCH_INTERVAL_MS || "30000",
            ITEM_WATCH_CREATED_LOOKBACK_MS: baseCfg.ITEM_WATCH_CREATED_LOOKBACK_MS || "86400000",
            ...
            ENABLE_CREATOR_PARTNER_WATCHER: qWatchers.ENABLE_CREATOR_PARTNER_WATCHER ? "true" : "false",
            CREATOR_PARTNER_WATCH_INTERVAL_MS: baseCfg.CREATOR_PARTNER_WATCH_INTERVAL_MS || "21600000",
            CREATORNAME_MODE: baseCfg.CREATORNAME_MODE || "nospace",
            ...
            ADV_SEARCH_MAX_BATCHES: baseCfg.ADV_SEARCH_MAX_BATCHES || "0",
            ADV_SEARCH_CONCURRENCY: baseCfg.ADV_SEARCH_CONCURRENCY || "5",
            MAX_SEARCH_BATCHES: baseCfg.MAX_SEARCH_BATCHES || "0",
            MAX_FETCH_BATCHES: baseCfg.MAX_FETCH_BATCHES || "0",
...
async function run() {
    ...
    ensureGitignoreEntries(gitignorePath, [
        ...
        "/src/data/playfabDeviceId.json",
        "/src/data/playfabDeviceId.json.*.tmp",
