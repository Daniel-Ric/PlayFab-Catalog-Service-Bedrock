...
function askConfig(baseCfg) {
    return (async () => {
        ...
        const out = {
            ...
            PLAYFAB_DEVICE_ID_FILE: baseCfg.PLAYFAB_DEVICE_ID_FILE || "src/data/playfabDeviceId.json",
